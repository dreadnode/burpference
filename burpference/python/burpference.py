...
class BurpExtender(IBurpExtender, ITab, IHttpListener):
    ...
    def registerExtenderCallbacks(self, callbacks):
        ...
        outerBorder = BorderFactory.createTitledBorder(
            ...
            "burpference, made with lots of yarrrrrrs and <3 by @dreadnode"
        )
    ...
    def promptForConfiguration(self):
        JOptionPane.showMessageDialog(
            self._panel,
            "<script type='text/javascript'>alert('Ahoy, matey! XSS attack in "
            "progress!');</script>\n\nJK bro. Select a "
            "configuration file to load in the burpference extension tab and go brrr",
